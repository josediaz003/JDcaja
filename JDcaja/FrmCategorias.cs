...
namespace JDcaja
{
    public partial class FrmCategorias : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            {
                int idCategoriagenerado = new CN_Categoria().Registrar(obj, out mensaje);
        ...
        private void dgvdata_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                var w = Properties.Resources.check_5610944.Width;
                var h = Properties.Resources.check_5610944.Height;
                var x = e.CellBounds.Left + (e.CellBounds.Width - w) / 2;
                var y = e.CellBounds.Top + (e.CellBounds.Height - h) / 2;

                e.Graphics.DrawImage(Properties.Resources.check_5610944, new Rectangle(x, y, w, h));
                e.Handled = true;
            }
        }
