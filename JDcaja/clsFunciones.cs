...
namespace JDcaja
{
    public class clsFunciones
    {
        ...
        public class CreaTicket
        {
            ...
            public static void EncabezadoVenta2()
            {
                string LineEncavesado = "Producto                             ";   // agrega lineas de  encabezados
                line.AppendLine(LineEncavesado);
            }
            public static void EncabezadoVenta()
            {
                string LineEncavesado = "Cod-Articulo   Cant   P.Unit    Valor";   // agrega lineas de  encabezados
                line.AppendLine(LineEncavesado);
            }
            ...
            public void Reportes(string Articulo, string precio, string cant, string subtotal)
            {
